...
class WorkoutControllerIntegrationTest {
	...
	void createAndListWorkoutsWithDevHeaders() throws Exception {
		MvcResult created = mockMvc.perform(post("/workouts")
		...
		String workoutId = com.jayway.jsonpath.JsonPath.read(
				created.getResponse().getContentAsString(),
				"$.id"
		);
		WorkoutDocument stored = mongoTemplate.findById(workoutId, WorkoutDocument.class);
		assertThat(stored).isNotNull();
		assertThat(stored.getCiphertext()).isNotBlank();
